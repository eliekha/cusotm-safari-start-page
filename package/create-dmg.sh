...
BriefDesk Installation Instructions
====================================

1. Drag "BriefDesk Installer" to Applications
2. Double-click to run the installer
3. Follow the setup wizard in your browser

After installation, set your browser homepage to:
   http://127.0.0.1:8765/start.html

For help, visit: https://github.com/eliekha/BriefDesk
